...
# define PLUGIN_NAME_078       "Energy (AC) - Eastron SDM120/SDM120CT/220/230/630/72D/DDM18SD/72D V2 [TESTING]"
...
# define P078_NR_OUTPUT_OPTIONS_SDM72D_V2                 41
...
unsigned int p078_getRegister(uint8_t query, uint8_t model) {
  if (model == 0) { // SDM220 & SDM120CT & SDM120
    ...
    switch (query) {
      ...
      case 16: return SDM_PHASE_2_POWER_FACTOR;
      case 17: return SDM_PHASE_3_POWER_FACTOR;
      case 18: return SDM_AVERAGE_L_TO_N_VOLTS;
      case 19: return SDM_AVERAGE_LINE_CURRENT;
      case 20: return SDM_SUM_LINE_CURRENT;
      case 21: return SDM_TOTAL_SYSTEM_POWER;
      ...
      case 33: return SDM_TOTAL_ACTIVE_ENERGY;
      case 34: return SDM_TOTAL_REACTIVE_ENERGY;
      case 35: return SDM_CURRENT_RESETTABLE_TOTAL_ACTIVE_ENERGY;
      case 36: return SDM_CURRENT_RESETTABLE_IMPORT_ENERGY;
      case 37: return SDM_CURRENT_RESETTABLE_EXPORT_ENERGY;
      case 38: return SDM_NET_KWH;
      case 39: return SDM_IMPORT_POWER;
      case 40: return SDM_EXPORT_POWER;
    }
  } 
  return 0;
}
...
const __FlashStringHelper* p078_getQueryString(uint8_t query, uint8_t model) {
  if (model == 0) { // SDM220 & SDM120CT & SDM120
    ...
    switch (query) {
      ...
      case 16: return F("Power Factor (cos-phi) Phase 2");
      case 17: return F("Power Factor (cos-phi) Phase 3");
      case 18: return F("Average line to neutral volts (V)");
      case 19: return F("Average line Current (A)");
      case 20: return F("Sum of line Currents (A)");
      case 21: return F("Total System Power (W)");
      ...
      case 29: return F("Line 2 to Line 3 Volts (V)");
      case 30: return F("Line 3 to Line 1 Volts (V)");
      case 31: return F("Average Line to Line Volts (V)");
      case 32: return F("Neutral Current (A)");
      case 33: return F("Total Active Energy (kwh)"); 
      case 34: return F("Total Reactive Energy (kVArh)");
      case 35: return F("Resettable Total Active Energy (kWh)"); 
      case 36: return F("Resettable Import Active Energy (kWh)"); 
      case 37: return F("Resettable Export Active Energy (kWh)"); 
      case 38: return F("Net  (Import - Export) (kWh)");
      case 39: return F("Total Import Active Power(kWh)"); 
      case 40: return F("Total Export Active Power(kWh)"); 
    }
  }
  return F("");
}
...
const __FlashStringHelper* p078_getQueryValueString(uint8_t query, uint8_t model) {
  if (model == 0) { // SDM220 & SDM120CT & SDM120
    ...
    switch (query) {
      ...
      case 21: return F("W");
      case 22: return F("VA");
      case 23: return F("kVArh/MVArh");
      case 24: return F("cos-phi");
      case 25: return F("Hz");
      case 26: 
      case 27: return F("kWh/MWh");
      case 28:
      case 29:
      case 30:
      case 31: return F("V");
      case 32: return F("A");
      case 33: return F("kWh/MWh");
      case 34: return F("kVArh/MVArh");
      case 35:
      case 36:
      case 37:
      case 38: return F("kWh/MWh");
      case 39: 
      case 40: return F("V");
    }
  return F("");
